...
object xgbClassifierTrainingExample {
  def main(args: Array[String]): Unit = {
    ...
    val schema = new StructType(Array(
      ...
      StructField("categorical feature 1", ArrayType, false),
      StructField("cf 2", ArrayType, false),
      StructField("cf 3", ArrayType, false),
      StructField("cf 4", ArrayType, false),
      StructField("cf 5", ArrayType, false),
      StructField("cf 6", ArrayType, false),
      StructField("cf 7", ArrayType, false),
      StructField("cf 8", ArrayType, false),
      StructField("cf 9", ArrayType, false),
      StructField("cf 10", ArrayType, false),
      StructField("cf 11", ArrayType, false),
      StructField("cf 12", ArrayType, false),
      StructField("cf 13", ArrayType, false),
      StructField("cf 14", ArrayType, false),
      StructField("cf 15", ArrayType, false),
      StructField("cf 16", ArrayType, false),
      StructField("cf 17", ArrayType, false),
      StructField("cf 18", ArrayType, false),
      StructField("cf 19", ArrayType, false),
      StructField("cf 20", ArrayType, false),
      StructField("cf 21", ArrayType, false),
      StructField("cf 22", ArrayType, false),
      StructField("cf 23", ArrayType, false),
      StructField("cf 24", ArrayType, false),
      StructField("cf 25", ArrayType, false),
      StructField("cf 26", ArrayType, false)
    ))
