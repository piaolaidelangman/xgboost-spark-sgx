...
object xgbClassifierTrainingExample {
  def main(args: Array[String]): Unit = {
    ...
    val schema = new StructType(Array(
      ...
      StructField("categorical feature 1", BinaryType, false),
      StructField("cf 2", BinaryType, false),
      StructField("cf 3", BinaryType, false),
      StructField("cf 4", BinaryType, false),
      StructField("cf 5", BinaryType, false),
      StructField("cf 6", BinaryType, false),
      StructField("cf 7", BinaryType, false),
      StructField("cf 8", BinaryType, false),
      StructField("cf 9", BinaryType, false),
      StructField("cf 10", BinaryType, false),
      StructField("cf 11", BinaryType, false),
      StructField("cf 12", BinaryType, false),
      StructField("cf 13", BinaryType, false),
      StructField("cf 14", BinaryType, false),
      StructField("cf 15", BinaryType, false),
      StructField("cf 16", BinaryType, false),
      StructField("cf 17", BinaryType, false),
      StructField("cf 18", BinaryType, false),
      StructField("cf 19", BinaryType, false),
      StructField("cf 20", BinaryType, false),
      StructField("cf 21", BinaryType, false),
      StructField("cf 22", BinaryType, false),
      StructField("cf 23", BinaryType, false),
      StructField("cf 24", BinaryType, false),
      StructField("cf 25", BinaryType, false),
      StructField("cf 26", BinaryType, false)
    ))
