...
import org.apache.spark.sql.types.{IntegerType, DoubleType, StringType, StructField, StructType, BinaryType, ArrayType, DecimalType, FloatType}
...
object xgbClassifierTrainingExample {
  def main(args: Array[String]): Unit = {
    ...
    val schema = new StructType(Array(
      ...
      StructField("categorical feature 1", IntegerType, false),
      StructField("cf 2", IntegerType, false),
      StructField("cf 3", IntegerType, false),
      StructField("cf 4", IntegerType, false),
      StructField("cf 5", IntegerType, false),
      StructField("cf 6", IntegerType, false),
      StructField("cf 7", IntegerType, false),
      StructField("cf 8", IntegerType, false),
      StructField("cf 9", IntegerType, false),
      StructField("cf 10", IntegerType, false),
      StructField("cf 11", IntegerType, false),
      StructField("cf 12", IntegerType, false),
      StructField("cf 13", IntegerType, false),
      StructField("cf 14", IntegerType, false),
      StructField("cf 15", IntegerType, false),
      StructField("cf 16", IntegerType, false),
      StructField("cf 17", IntegerType, false),
      StructField("cf 18", IntegerType, false),
      StructField("cf 19", IntegerType, false),
      StructField("cf 20", IntegerType, false),
      StructField("cf 21", IntegerType, false),
      StructField("cf 22", IntegerType, false),
      StructField("cf 23", IntegerType, false),
      StructField("cf 24", IntegerType, false),
      StructField("cf 25", IntegerType, false),
      StructField("cf 26", IntegerType, false)
    ))
