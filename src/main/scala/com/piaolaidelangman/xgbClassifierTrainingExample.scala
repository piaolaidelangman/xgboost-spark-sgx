...
object xgbClassifierTrainingExample {
  def main(args: Array[String]): Unit = {
    ...
    val schema = new StructType(Array(
      ...
      StructField("categorical feature 1", DecimalType.LongDecimal, false),
      StructField("cf 2", DecimalType.LongDecimal, false),
      StructField("cf 3", DecimalType.LongDecimal, false),
      StructField("cf 4", DecimalType.LongDecimal, false),
      StructField("cf 5", DecimalType.LongDecimal, false),
      StructField("cf 6", DecimalType.LongDecimal, false),
      StructField("cf 7", DecimalType.LongDecimal, false),
      StructField("cf 8", DecimalType.LongDecimal, false),
      StructField("cf 9", DecimalType.LongDecimal, false),
      StructField("cf 10", DecimalType.LongDecimal, false),
      StructField("cf 11", DecimalType.LongDecimal, false),
      StructField("cf 12", DecimalType.LongDecimal, false),
      StructField("cf 13", DecimalType.LongDecimal, false),
      StructField("cf 14", DecimalType.LongDecimal, false),
      StructField("cf 15", DecimalType.LongDecimal, false),
      StructField("cf 16", DecimalType.LongDecimal, false),
      StructField("cf 17", DecimalType.LongDecimal, false),
      StructField("cf 18", DecimalType.LongDecimal, false),
      StructField("cf 19", DecimalType.LongDecimal, false),
      StructField("cf 20", DecimalType.LongDecimal, false),
      StructField("cf 21", DecimalType.LongDecimal, false),
      StructField("cf 22", DecimalType.LongDecimal, false),
      StructField("cf 23", DecimalType.LongDecimal, false),
      StructField("cf 24", DecimalType.LongDecimal, false),
      StructField("cf 25", DecimalType.LongDecimal, false),
      StructField("cf 26", DecimalType.LongDecimal, false)
    ))
